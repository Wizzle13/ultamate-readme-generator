...
function frontendLanguagesSection(readmeData) {
  ...
  for (let i=0; i<frontArray.length; i++) {
    switch(frontArray[i]) {
      case 'NONE' :
        languageBadges += `![None](https://img.shields.io/badge/None-blue)`;
        break;
      case 'Angular' :
...
function databaseSection(readmeData) {
  ...
  let databaseBadges = ``;
    ...
    switch(databaseArray) {
      case 'NONE' :
        databaseBadges += `![None](https://img.shields.io/badge/None-blue)`;
        break;
      case 'MongoDB' :
...
function toolsSection(readmeData) {
  ...
  for (let i=0; i<toolsArray.length; i++) {
    switch(toolsArray[i]) {
      case 'NONE' :
        toolsBadges += `![None](https://img.shields.io/badge/None-blue)`;
        break;
      case 'AWS' :
